...
def forecast(lat, lon):
    ...
    text = ''
    for i in range(7):
        text += f'В этот день будет {one_call.forecast_daily[i].detailed_status}, температура воздуха днем {one_call.forecast_daily[i].temperature("celsius").get("day")} градусов\n'
    return text
